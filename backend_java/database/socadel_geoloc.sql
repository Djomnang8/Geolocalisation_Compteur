...
CREATE TABLE rapport_inspection (
  ...
  photo_donnees      LONGBLOB COMMENT 'Octets JPEG de la photo, consultes par l''administrateur',
  fichier            VARCHAR(190),
  fichier_donnees    LONGBLOB COMMENT 'Octets du fichier joint (PDF, DOCX...)',
